...
export function RelationshipReferenceRow({ modelId, relationship, reference, canEdit, onTogglePrimaryKey, onToggleForeignKey, onToggleVisibility, onDelete }: RelationshipReferenceRowProps) {
