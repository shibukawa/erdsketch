    ...
    <div className="modal-box flex h-[min(82vh,640px)] max-w-2xl flex-col rounded-xl bg-white p-0">
      ...
      <div data-tour="collaboration-connection" className="min-h-0 flex-1 overflow-y-auto p-6">
        ...
        {sharing.invitationUrl && <section className="space-y-4">
          <div><h3 className="font-bold text-blue-950">1. Send this invitation URL</h3>{sharing.hostInvitationLabel && <p data-i18n-skip className="mt-1 text-sm font-medium text-blue-900">{sharing.hostInvitationLabel}</p>}<p className="text-xs text-blue-800">Keep this tab and dialog open while the participant prepares an answer. Each invitation connects one collaborator.</p></div>
