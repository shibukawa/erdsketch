...
import { maturedLevelSteps, maturedStepLabels, roleMeta, roleOptions } from "../../features/modeling/constants";
...
export function DfdSelectionInspector({ node, group, flow, model, nodes, groups, models, externalDefinitions, onUpdateNode, onUpdateFlow, onUpdateModel, onUngroup, onDelete }: Props) {
  ...
  const handleMaturity = useCallback((value: number) => onUpdateModel({ maturedLevel: clampMaturedLevel(value) }), [onUpdateModel]);
